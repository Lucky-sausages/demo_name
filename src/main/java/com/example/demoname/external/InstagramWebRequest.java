...
class InstagramWebRequest extends WebRequest
{
    ...
    DocumentContext getProfileParsedJson(String profileName)
    {
        String url = String.format("https://instagram.com/%s/?__a=1", profileName);
        return getParsedJson(url);
    }

    DocumentContext getPostParsedJson(String postShortCode)
    {
